...
export const results = [
  {
    type: 'white',
    title: '화이트 쿠키 빼빼로',
    description: '당신은 사람들 사이에서 빛나는 분위기 메이커!\n 당신은 모두의 사랑을 받는 에너자이저예요.\n밝고 긍정적인 에너지로 주변을 환하게 만드는 매력이 있습니다.',
    traits: [
      '✨ 깔끔하고 정돈된 스타일 선호',
      '🤍 순수하고 밝은 이미지',
      '💫 심플하지만 세련된 감각',
  ...
  },
  {
    type: 'nude',
    title: '초코필드 빼빼로',
    description: '당신은 은은하지만 따뜻한 편안함의 대명사!\n따뜻하고 부드러운 매력으로 사람들에게 편안함을 주는 스타일이에요.\n겉으로는 조용해 보여도 속으로는 깊이 공감하고 배려하는, 알면 알수록 매력적인 사람이에요.',
    traits: [
      '🌾 자연스럽고 편안한 분위기',
      '☕ 따뜻하고 부드러운 성격',
      '🧸 포근하고 아늑한 매력',
  ...
  },
  {
    type: 'original',
    title: '오리지널 빼빼로',
    description: '당신은 믿음직한 적이고 클래식한 오리지널 빼빼로!\n책임감 있게 행동하는 당신은 주변 사람들에게 가장 신뢰받는 존재예요.\n언제나 든든한 당신은 어른스러운 매력의 소유자랍니다.',
    traits: [
      '🍫 클래식하고 정통적인 스타일',
      '⭐ 변하지 않는 가치 추구',
      '🎯 믿음직하고 안정적',
  ...
  },
  {
    type: 'almond',
    title: '아몬드 빼빼로',
    description: '당신은 독특한 개성파 아몬드 빼빼로!\n특별함을 추구하며 자신만의 스타일을 가지고 있어요.\n출석보다 출코, 남들과 다른 유니크한 매력으로 눈길을 사로잡습니다.',
    traits: [
      '🌰 독특하고 개성 있는 스타일',
      '✨ 특별함을 추구하는 성향',
      '🎨 창의적이고 유니크한 감각',
